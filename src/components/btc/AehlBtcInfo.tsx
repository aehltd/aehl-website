        ...
        <div className='p-3 md:col-span-2 col-span-1'>
          ...
          <div className='flex justify-end'>
            <div className='p-2'>
              ...
              <Link href="https://www.btcshorts.com/#/" className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-pink-700 transition duration-300 ease-out border-2 border-pink-700 rounded-full shadow-md group">
